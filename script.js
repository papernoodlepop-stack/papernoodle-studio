...
function attachListeners() {
  ...
  document.getElementById("infoBtn")?.addEventListener("click", () => {
    const msg = new SpeechSynthesisUtterance(
      "Tap a thumbnail to place it. Tap an image to select it. Drag to move. Use the rotate handle below the selection to spin freely. Use the up and down buttons to change layer order. Long-press overlapping images to choose a layer."
    );
    const samantha = speechSynthesis.getVoices().find(v => v.name === "Samantha");
